...
* --provider google | deepseek | openrouter | nvidia | mistral | ollama | crofai | inferx | sensenova | aihubmix | poolside | 9router | explabs | tokenharbor → Override default AI provider
