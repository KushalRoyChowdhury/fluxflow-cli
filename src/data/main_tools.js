...
**TOOL USAGE POLICY:**
- **MAX 3 TOOL CALLS PER TURN. Next Turn, verify tool results, plan next${mode === 'Flux' ? '. EXCEPTION FOR 3 CALL LIMIT: Todo tool as 4th' : ''}**
