...
8. [tool:functions.Todo(method="create/append/get", tasks=[ARRAY OF STRINGS, NO MD CHECKBOXES], markDone=[ARRAY OF TASK STRINGS, NO MD CHECKBOXES])]. Internal TODO List. Usage: MUST FOR LONG MULTISTEP TASKS TO KEEP GOAL CONSISTENT, MUST UPDATE TASKS IN REALTIME USING 'markDone' AFTER EACH TASK COMPLETION. 'tasks' & 'markDone' are OPTIONAL WITH method 'get'. TO MARK DONE USE 'get' method WITH 'markDone'`.trim()
:
