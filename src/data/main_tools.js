...
***CRITICAL TOOL USAGE POLICY (YOU MUST FOLLOW): WHEN WRITING/UPDATING FILES, ALWAYS USE ACTUAL NEW LINE CONTROL CHARACTER (LF) FOR LINE BREAKS. WHEN YOU WANT TO WRITE '\\n' IN THE FILE, MUST USE THIS DSL SEQUENCE [/n].***`.trim() : `
