        ...
        <div className="lg:hidden sticky top-0 z-40 transition-colors duration-300 select-none">
            <div className="flex items-center justify-between px-4 py-3 bg-white/80 dark:bg-black/80 backdrop-blur-sm border-b border-slate-200 dark:border-white/10">
                <div className="flex items-center gap-2">
                    <img src="/logo.png" alt="FluxFlow Logo" className="w-7 h-7 rounded object-contain shadow-lg shadow-blue-500/20" />
                ...
                {open && (
                    <>
                        ...
                        <motion.aside
                            ...
                            className="fixed left-0 top-0 bottom-0 w-72 bg-white dark:bg-black z-50 overflow-y-auto px-6 py-8 shadow-2xl border-r dark:border-white/10 flex flex-col justify-between"
                        >
                            <div className="flex-1">
                                <div className="flex items-center gap-3 mb-10">
                                    <img src="/logo.png" alt="FluxFlow Logo" className="w-8 h-8 rounded-lg object-contain shadow-lg shadow-blue-500/20" />
