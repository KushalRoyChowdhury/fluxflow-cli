    ...
    return (
        <DocPage headings={headings}>
            ...
            <ul>
                ...
                <li><strong>AI API Key</strong> — Google Gemini, DeepSeek, NVIDIA, OpenRouter, Mistral, Ollama, CrofAI, InferX, Sensenova, AIHubMix, Poolside, 9router (anything based on your taste, we dont judge here ...maybe)</li>
            </ul>
