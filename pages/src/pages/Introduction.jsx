...
export default function Introduction() {
    return (
        <DocPage headings={headings}>
            ...
            <ul>
                <li><strong>Multi-Provider Support</strong> — Google Gemini/Gemma, DeepSeek, NVIDIA, OpenRouter, Mistral, Ollama, AIHubMix, CrofAI, InferX, Sensenova, Poolside, 9router, AIHubMix, ExperimentalLabs (anything based on your taste, we dont judge here)</li>
