...
export default function StableModels() {
    return (
        <DocPage headings={headings}>
            ...
            <p>
                The default and highly integrated provider, offering native multimodal capabilities
            ...
            <p>
                Offers high-intelligence reasoning and efficient processing, ideal for complex
                coding tasks.
            </p>
            <div className="overflow-x-auto">
                <table>
            ...
            <p>
                Access to a curated selection of powerful open-source and proprietary models.
            </p>
            <div className="overflow-x-auto">
                <table>
                    <thead>
            ...
            <p>
                A unified interface to access a massive ecosystem of AI models, categorized
                by Free and Paid tiers.
            </p>
