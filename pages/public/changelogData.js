...
export const changelogData = {
    ...
    "4.20.0": {
        "note": "SEPTEMBER 26",
        "added": [
            "Added conversation context for `fluxflow -p ‹prompt›`. Context will be retained till 10m of inactivity or 69 turns. To start a clean turn without context, use `--new` (alias `-n`) flag."
        ],
        "changed": [],
        "fixes": [
    ...
    "4.17.0": {
        ...
        "added": [],
        "changed": [
            "Changed tools schema to be more token efficient & less model hallucunations.",
            "Improved Skill loading system."
        ],
        "fixes": []
    },
    "4.16.17": {
    ...
    "4.16.12": {
        "note": "SEPTEMBER 18",
        "added": [
            "Added User Intervention for Safety Loop limits."
        ],
        "changed": [],
        "fixes": []
    },
    ...
    "4.11.0": {
        "note": "SEPTEMBER 11",
        "added": [
            "Improved the GUI Usage Analytics.",
            "Improved App boot times by ~90%."
        ],
        "changed": [],
        "fixes": [
            "Fixed a bug in Cache Token calculations in Status Bar.",
            "Bug fixes on several components."
        ]
    },
    "4.9.0": {
        "note": "SEPTEMBER 10",
    ...
    "4.8.5": {
        ...
        "added": [],
        "changed": [
            "Cache Hit %% now shows in the status bar, & moved the active context usage to `/stats`.",
            "Few UI tweaks."
        ],
        "fixes": [
            "Minor Bug Fixes."
    ...
    "4.8.3": {
        ...
        "changed": [],
        "fixes": [
            "Fixed few bugs with IDE detection."
        ]
    },
    "4.8.0": {
        "note": "SEPTEMBER 01",
    ...
    "4.6.3": {
        ...
        "added": [],
        "changed": [
            "Minor adjustments for `AGENTS.md` & `Skills` for better experience."
        ],
        "fixes": []
    },
    "4.6.0": {
    ...
    "4.5.0": {
        ...
        "fixes": [
            "QoL bug fixes.",
            "Reduce *few* tool's ambiguity.",
            "Major rework to reduce false-positives with system schemas with contextual states."
        ]
    },
    "4.4.0": {
        "note": "AUGUST 24",
    ...
    "4.3.2": {
        ...
        "added": [],
        "changed": [
            "Optimized System prompt further ...cuz why not!?"
        ],
        "fixes": [
            "Fixed critical issues with UI rendering."
        ]
    },
    "4.3.0": {
        "note": "AUGUST 21",
